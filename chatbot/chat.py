...
vertexAI = ChatVertexAI(
    model_name=ai_model, streaming=True, convert_system_message_to_human=True
)
...
text_embed = os.getenv("TEXT_EMBED")
if not text_embed:
    text_embed = "text-embedding-005"
embedding_model = VertexAIEmbeddings(text_embed)
...
if not app_title:
    app_title = "🤖 chatbot Chatbot"
st.title(app_title)
if "messages" not in st.session_state:
    app_content = os.getenv("APP_CONTENT")
    if not app_content:
        app_content = "Welcome to chatbot! How can I help you?"
